def call(def lock_resource_name, def robot_result_folder, def rtMaven, def server, def Docker_Reg_Name, def om_image_name, def cp_image_name, def Docker_Registry_URL, def Docker_Credentials, def image_version, def jar_name) {
println "Inside"
